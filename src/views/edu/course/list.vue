      ...
      <el-table-column label="操作" align="center" style="height: 100%;">
        <template slot-scope="scope">
          ...
          <router-link :to="'/course/chapter/'+scope.row.id">
            <el-button type="primary" plain="true" size="mini" icon="el-icon-edit" style="margin-top: 10px">编辑课程大纲信息</el-button>
          </router-link>
          <br>
          <el-button type="danger" plain="true" size="mini" icon="el-icon-delete" style="margin-top: 10px" @click="removeDataById(scope.row.id)">&nbsp;&nbsp;&nbsp;&nbsp;删除课程信息&nbsp&nbsp&nbsp</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  //引入调用course.js文件
  import courseApi from '@/api/teacher/course.js'

  //引入调用teacher.js文件
  import teacherApi from '@/api/teacher/teacher.js'

  //引入调用subject.js文件
  import subjectApi from '@/api/teacher/subject.js'
